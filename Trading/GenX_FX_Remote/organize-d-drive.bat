...
if exist "D:\GenX_FX\.env" (
    ...
    powershell -Command "(Get-Content 'D:\GenX_FX\.env') -replace 'E:\\\\Code\\\\GenX_FX-1', 'D:\\\\GenX_FX' | Set-Content 'D:\GenX_FX\.env'"
)

REM Update any batch files with new paths
for /r "D:\GenX_FX" %%f in (*.bat) do (
    echo Updating paths in %%~nxf...
    powershell -Command "(Get-Content '%%f') -replace 'E:\\\\Code\\\\GenX_FX-1', 'D:\\\\GenX_FX' | Set-Content '%%f'"
)
